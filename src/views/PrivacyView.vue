<template>
        <div class="container">
                ...
                <p class="underline">Last updated: October 21, 2023</p>
                ...
                <ul>
                        ...
                        <li>
                                <p><strong>Application</strong> refers to SimpliSplit, the software program provided by the
                                        Company.</p>
                        </li>
                        <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SimpliSplit.</p>
                        </li>
                        <li>
                ...
                <p>We use this information to provide features of Our Service, to improve and customize Our Service. The
                        information may
                        be uploaded to the Company's servers and/or a Service Provider's server or it may be simply stored on
                        Your
                        device.</p>
                ...
                <p>
                        By visiting this page on our website: <a href="https://SimpliSplit.com" rel="external nofollow noopener"
                                target="_blank">https://SimpliSplit.com</a>
                </p>
        </div>
</template>
